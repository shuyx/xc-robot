ªU¥ZB`ÜRcmd1,Rcmd2,Rcmd3,Rcmd4 = GetGripCmd()
T1 = {0x01,0x10,0x9C,0x48,0x00,0x01,0x02,0x00,0x01,0x34,0x11}
T2 = {0x01,0x10,0x9C,0x40,0x00,0x01,0x02,0x00,0x64,0xF5,0x72}
T3 = {0x01,0x10,0x9C,0x41,0x00,0x01,0x02,0x00,0x32,0x74,0x9D}
T4 = {0x01,0x03,0x9C,0x45,0x00,0x01,0xBB,0x8F}
T5 = {0x01,0x03,0x9C,0x46,0x00,0x01,0x4B,0x8F}
if(Rcmd1 == 1) then
    DelayMs(3)
    T1[1] = Rcmd2
    T2[1] = Rcmd2
    ...
    if (Rcmd3 == 0x08) then
    T5[7],T5[8] = CrcValue(T5[1],T5[2],T5[3],T4[4],T5[5],T5[6])
