ªU¥ZÎ ,Rcmd1,Rcmd2,Rcmd3,Rcmd4 = GetGripCmd()
T1 = {0x01,0x10,0x9C,0x40,0x00,0x01,0x02,0x00,0x64,0xF5,0x72}
T2 = {0x01,0x10,0x9C,0x41,0x00,0x01,0x02,0x00,0x32,0x74,0x9D}
