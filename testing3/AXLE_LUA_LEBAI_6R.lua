-- 乐白夹爪6R机器人末端协议文件
-- 基于GripExample.lua模板，专为6R机器人优化
-- 只包含必要的T1-T6指令数组

-- 乐白夹爪Modbus指令定义
T1 = {0x01, 0x10, 0x9C, 0x9A, 0x00, 0x01, 0x02, 0x01}  -- 关闭自动找行程
T2 = {0x01, 0x10, 0x9C, 0x48, 0x00, 0x01, 0x02, 0x01}  -- 手动找行程  
T3 = {0x01, 0x10, 0x9C, 0x40, 0x00, 0x01, 0x02, 0x00}  -- 设置位置
T4 = {0x01, 0x10, 0x9C, 0x41, 0x00, 0x01, 0x02, 0x00}  -- 设置力度
T5 = {0x01, 0x03, 0x9C, 0x45, 0x00, 0x01, 0x00, 0x00}  -- 读取位置
T6 = {0x01, 0x03, 0x9C, 0x46, 0x00, 0x01, 0x00, 0x00}  -- 读取力矩
