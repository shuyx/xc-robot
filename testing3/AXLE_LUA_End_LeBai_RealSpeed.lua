...
T1 = {0x01,0x10,0x9C,0x40,0x00,0x01,0x02,0x00,0x64}
T2 = {0x01,0x10,0x9C,0x41,0x00,0x01,0x02,0x00,0x32}
T3 = {0x01,0x03,0x9C,0x45,0x00,0x01}
T4 = {0x01,0x03,0x9C,0x46,0x00,0x01}
T5 = {0x01,0x10,0x9C,0x4A,0x00,0x01,0x02,0x00,0x32}
T6 = {0x01,0x03,0x9C,0x4A,0x00,0x01}
if(Rcmd1 == 1) then
    DelayMs(3)
    T1[1] = Rcmd2
    T2[1] = Rcmd2
